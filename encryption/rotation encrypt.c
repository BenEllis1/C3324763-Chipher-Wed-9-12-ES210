...
=====================================================================*/
#include<stdio.h>
void encrypt_me(char *,int);// declaring enrcyption function
int main()
{
   char ch[50]="HELLO WORLD"; //the string to be encrypted
  
encrypt_me(ch,1);// calling the function
return 0;
}
 
void encrypt_me(char *ar,int x)//function definition
{
